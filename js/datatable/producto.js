        ...
        columnDefs: [
         {
            ...
            },
            {
                ...
                orderable: false,
                render: function (data, type, row) {
                    var buttons = '<a href="/inventario/producto_modificacion/' + row.id + '" class="btn btn-warning btn-xs btn-flat"><i class="fas fa-edit"></i></a> ';
                    buttons += '<a href="/inventario/producto_eliminacion/' + row.id + '" type="button" class="btn btn-danger btn-xs btn-flat"><i class="fas fa-trash-alt"></i></a>';
                    return buttons;
                }
            },
        ],
